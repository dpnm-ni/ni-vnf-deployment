...
def deploy_vnf(deployment, prefix):
    ...
    # prefix°¡ NoneÀÌžé 'sh-'žŠ µðÆúÆ®·Î ŒÂÆÃÇÏ°Ô ÇÔ
...
def add_sfcr(prefix):
    with open('./traf.txt', 'r') as ref:
        ...
        for i in range (0, nlines):
            ...
            # nf_chain ¿¡ sfc_type À» Ç¥œÃÇÏ±â À§ÇÔ
            last_idx = -1
            ...
            sfc_type_idx = 0  # Á€ÀÇµÇÁö ŸÊÀº sfc_type ÀÎ °æ¿ì 0Àž·Î Ç¥œÃ
...
def ilp_deployment_decision():
    ...
    # CPLEX ·Î±×ÆÄÀÏ ÆÄœÌ
    deployment = np.zeros((1, 13, 7))  # topology file°ú middlebox-spec¿¡Œ­ ÂüÁ¶ÇÏµµ·Ï ŒöÁ€ => (1, n_node, n_vnf_type)
